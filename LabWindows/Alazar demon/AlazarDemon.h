...
#define  PANEL_DATALOOPS                  3       /* control type: numeric, callback function: (none) */
#define  PANEL_ALAZARLOOPS                4       /* control type: numeric, callback function: (none) */
#define  PANEL_BUFFERSIZE                 5       /* control type: numeric, callback function: (none) */
#define  PANEL_MAXSAMPLESPERCHANNEL       6       /* control type: numeric, callback function: (none) */
#define  PANEL_BYTESPERSAMPLE             7       /* control type: numeric, callback function: (none) */
#define  PANEL_SYSTEMCOUNT                8       /* control type: numeric, callback function: (none) */
#define  PANEL_BOARDNUMBER                9       /* control type: numeric, callback function: (none) */
...
#define  PANEL_STOPBUTTON                 34      /* control type: textButton, callback function: (none) */
...
#define  PANEL_RAWALINESIZE               37      /* control type: numeric, callback function: (none) */
#define  PANEL_ERRORMSG                   38      /* control type: textBox, callback function: (none) */
